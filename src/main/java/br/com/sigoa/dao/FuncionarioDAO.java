...
public class FuncionarioDAO {
	...
	static public void DELETE(Funcionario funcionario) {
		...
		try {
			...
			stmt.setString(1, funcionario.getId_funcionario().toString());
			
			stmt.executeUpdate();
			
			JOptionPane.showMessageDialog(null, "Funcionário deletado!", "Sucess", 2);
